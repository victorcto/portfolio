...
<sub>Desenvolvedor e cientista de dados em formação. </sub>
<h3> Sobre mim </h3>
...
<p> No começo da minha graduação entrei na empresa júnior do meu curso: a EJECT. E foi lá que eu pude perceber que, apesar dessa parte do front-end web ter me introduzido à programação não era isso que queria trabalhar no meu dia a dia. Por consequência, busquei ainda mais novas áreas. Paguei duas matérias de programação na faculdade e procurando conhecimento em casa, vi que desenvolvedor de software (back-end) e Ciência de dados faz mais meu estilo. Por isso, que estou migrando de curso e possuo conhecimento em algumas linguagens de programação. </p>
<h3> Conhecimentos </h3>
<ul>
